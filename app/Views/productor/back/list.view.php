                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="d-none d-sm-table-cell" title="<?= $productor['country_name']?>"><?= $productor['iso3'] ?? 'NULL' ?></td>
                                    <td class="d-flex flex-column d-sm-table-cell">
                                        <a href="/admin/productor/show/<?=  $productor['productor_id'] ?>" class="btn btn-secondary btn-sm mb-2 mb-lg-auto">
                                            <i class="fa fa-eye"></i>
                                            <span class="sr-only">Cliquer pour voir : <?=$productor["productor_name"]?></span>
                                        </a>
                                        <a href="/admin/productor/edit/<?=  $productor['productor_id'] ?>" class="btn btn-primary btn-sm mb-2 mb-lg-auto">
                                            <i class="fa fa-edit"></i>
                                            <span class="sr-only">Cliquer pour modifier : <?=$productor["name"]?></span>
                                        </a>
                                        <a href="/admin/productor/delete/<?=  $productor['productor_id'] ?>" class="btn btn-danger btn-sm mb-2 mb-lg-auto">
